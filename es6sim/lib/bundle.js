...
var Army = function () {
    function Army() {
        ...
        this.HQ.world = new world_1.default(this.HQ);
    }
...
},{"./config":4,"./hq":7,"./unit":19,"./world":20}],3:[function(require,module,exports){
'use strict';
...
},{"./actions":1,"./config":4,"./ui-game.jsx":18}],6:[function(require,module,exports){
'use strict';
...
},{"./army":2,"./engine":5,"./keyboard":8}],7:[function(require,module,exports){
'use strict';
...
},{"./config":4,"./officers":12,"./operations":13}],8:[function(require,module,exports){
"use strict";
...
},{"./config":4,"./traits":17}],12:[function(require,module,exports){
'use strict';
const config_1 = require("./config");
...
},{"./config":4,"./officer":11,"./player":14,"./secretary":16}],13:[function(require,module,exports){
'use strict';
...
var Player = function (_officer_1$default) {
    _inherits(Player, _officer_1$default);
...
var comparisons = new comparisons_1.default();
...
var Ui = function () {
    ...
    _createClass(Ui, [{
        ...
        value: function render(army) {
            react_1.default.render(react_1.default.createElement(Army, { engine: this.engine }), document.body);
        }
    }]);
...
var Army = function (_react_1$default$Comp) {
    _inherits(Army, _react_1$default$Comp);
    ...
    _createClass(Army, [{
        ...
        value: function render() {
            ...
            return react_1.default.createElement("div", { className: "army" }, react_1.default.createElement("p", { className: "date" }, army.HQ.realDate), react_1.default.createElement("div", null, react_1.default.createElement(Player, { player: army.HQ.player, engine: engine }), react_1.default.createElement(Inspected, { officer: army.HQ.findInspected(), engine: engine })), react_1.default.createElement(Unit, { officer: army.HQ.player, engine: engine }), react_1.default.createElement(Structure, { units: army.units.corps, engine: engine }));
        }
    }]);
...
var Structure = function (_react_1$default$Comp2) {
    _inherits(Structure, _react_1$default$Comp2);
    ...
    _createClass(Structure, [{
        ...
        value: function render() {
            ...
            if (!units.length) return react_1.default.createElement("div", null);
            var names = [];
            units.forEach(function (unit) {
                unit.isRed = _this3.state.engine.army.HQ.officers.inspected && unit.commander.id === _this3.state.engine.army.HQ.officers.inspected.id || unit.commander.isPlayer ? 'isRed' : '';
            });
            return react_1.default.createElement("div", null, react_1.default.createElement("div", { className: units[0].type + ' ' + units[0].isRed }, react_1.default.createElement("div", { onClick: this.inspect.bind(this, [units[0].commander]) }, units[0].name), react_1.default.createElement(Structure, { units: units[0].subunits, engine: this.state.engine })), react_1.default.createElement("div", { className: units[1].type + ' ' + units[1].isRed }, react_1.default.createElement("div", { onClick: this.inspect.bind(this, [units[1].commander]) }, units[1].name), react_1.default.createElement(Structure, { units: units[1].subunits, engine: this.state.engine })));
        }
    }]);
...
var Player = function (_react_1$default$Comp3) {
    _inherits(Player, _react_1$default$Comp3);
    ...
    _createClass(Player, [{
        ...
        value: function render() {
            ...
            return react_1.default.createElement("div", { className: "player" }, react_1.default.createElement("div", { onClick: this.inspect.bind(this) }, player.name()), react_1.default.createElement("div", null, this.state.engine.army.HQ.findUnitById(player.unitId).name), react_1.default.createElement(Stats, { officer: player, engine: this.state.engine }), react_1.default.createElement(Staff, { officer: player, engine: this.state.engine }));
        }
    }]);
...
var Inspected = function (_react_1$default$Comp4) {
    _inherits(Inspected, _react_1$default$Comp4);

    function Inspected(props) {
        _classCallCheck(this, Inspected);

        var _this5 = _possibleConstructorReturn(this, (Inspected.__proto__ || Object.getPrototypeOf(Inspected)).call(this, props));

        _this5.state = {
            officer: _this5.props.officer,
            engine: _this5.props.engine
        };
        return _this5;
    }

    _createClass(Inspected, [{
        key: "render",
        value: function render() {
            if (!this.props.officer) return react_1.default.createElement("div", null);
            var army = this.state.engine.army;
            var officer = this.props.officer;
            var engine = this.state.engine;
            var superior = army.HQ.findCommandingOfficer(officer);
            var superiorHTML = !this.props.officer.reserved && !this.props.officer.isPlayer && this.props.officer.rank.hierarchy < 7 ? react_1.default.createElement("div", { className: "superior" }, react_1.default.createElement("div", null, "Commanding Officer"), react_1.default.createElement(Officer, { officer: superior, engine: this.state.engine })) : react_1.default.createElement("div", null);
            var headerHTML = !this.props.officer.isPlayer ? react_1.default.createElement("div", null, react_1.default.createElement("h1", null, "Officer"), react_1.default.createElement(Officer, { officer: officer, engine: this.state.engine }), react_1.default.createElement(Stats, { officer: officer, engine: this.state.engine })) : react_1.default.createElement("div", null);
            return react_1.default.createElement("div", { className: "inspected" }, headerHTML, superiorHTML, react_1.default.createElement(History, { officer: officer, engine: this.state.engine }));
        }
    }]);
...
var Staff = function (_react_1$default$Comp5) {
    _inherits(Staff, _react_1$default$Comp5);

    function Staff(props) {
        _classCallCheck(this, Staff);

        var _this6 = _possibleConstructorReturn(this, (Staff.__proto__ || Object.getPrototypeOf(Staff)).call(this, props));
    ...
    _createClass(Staff, [{
        ...
        value: function render() {
            ...
            army.HQ.findOperationalStaff(this.state.officer).forEach(function (officer) {
                staff.push(react_1.default.createElement("li", null, react_1.default.createElement(Officer, { officer: officer, engine: _this7.state.engine })));
            });
            var superiorHTML = !this.state.officer.reserved ? react_1.default.createElement("div", null, react_1.default.createElement("div", null, "Commanding Officer"), react_1.default.createElement(Officer, { officer: superior, engine: this.state.engine })) : react_1.default.createElement("div", null);
            var staffHTML = staff.length && !this.state.officer.reserved ? react_1.default.createElement("div", null, superiorHTML, react_1.default.createElement("h2", null, "Staff"), react_1.default.createElement("ul", { className: "staff" }, staff)) : react_1.default.createElement("div", null, superiorHTML);
            return staffHTML;
        }
    }]);
...
var Officer = function (_react_1$default$Comp6) {
    _inherits(Officer, _react_1$default$Comp6);

    function Officer(props) {
        _classCallCheck(this, Officer);

        var _this8 = _possibleConstructorReturn(this, (Officer.__proto__ || Object.getPrototypeOf(Officer)).call(this, props));

        _this8.state = {
            engine: _this8.props.engine,
            officer: _this8.props.officer
        };
        return _this8;
    }
    ...
    _createClass(Officer, [{
        ...
        key: "render",
        value: function render() {
            var html = this.props.officer ? react_1.default.createElement("div", null, react_1.default.createElement("div", { onClick: this.inspect.bind(this) }, this.props.officer.name())) : react_1.default.createElement("div", null);
            return html;
        }
    }]);
...
var Stats = function (_react_1$default$Comp7) {
    _inherits(Stats, _react_1$default$Comp7);
    ...
    _createClass(Stats, [{
        key: "render",
        value: function render() {
            var html = this.props.officer ? react_1.default.createElement("div", { className: "stats" }, react_1.default.createElement("div", null, "INT ", this.props.officer.intelligence), react_1.default.createElement("div", null, "MIL ", this.props.officer.commanding), react_1.default.createElement("div", null, "DIP ", this.props.officer.diplomacy)) : react_1.default.createElement("div", { className: "stats" });
            return html;
        }
    }]);
...
var History = function (_react_1$default$Comp8) {
    _inherits(History, _react_1$default$Comp8);

    function History(props) {
        _classCallCheck(this, History);

        var _this10 = _possibleConstructorReturn(this, (History.__proto__ || Object.getPrototypeOf(History)).call(this, props));
        ...
        value: function render() {
            ...
            if (this.props.officer) {
                this.props.officer.history.forEach(function (event) {
                    history.push(react_1.default.createElement("li", { className: "log" }, event));
                });
            }
            var html = this.props.officer ? react_1.default.createElement("div", { className: "history" }, react_1.default.createElement("div", null, "Record"), react_1.default.createElement("ul", null, history)) : react_1.default.createElement("div", null);
            return html;
        }
    }]);
...
var Unit = function (_react_1$default$Comp9) {
    _inherits(Unit, _react_1$default$Comp9);

    function Unit(props) {
        _classCallCheck(this, Unit);

        var _this11 = _possibleConstructorReturn(this, (Unit.__proto__ || Object.getPrototypeOf(Unit)).call(this, props));

        _this11.state = {
            player: _this11.props.officer,
    ...
    _createClass(Unit, [{
        ...
        value: function render() {
            ...
            types.forEach(function (type) {
                operationTypes.push(react_1.default.createElement("option", null, type));
            });
            staff.forEach(function (officer) {
                staffOfficers.push(react_1.default.createElement("option", { value: [officer.id, player.unitId] }, officer.name()));
            });
            targets.forEach(function (target) {
                officers.push(react_1.default.createElement("option", { value: target.id }, target.name()));
            });
            operationTypes.unshift(react_1.default.createElement("option", null));
            officers.unshift(react_1.default.createElement("option", null));
            staffOfficers.unshift(react_1.default.createElement("option", null));
            return react_1.default.createElement("div", { className: "unit" }, react_1.default.createElement("h1", null, "Headquarters"), react_1.default.createElement("div", null, "Operation name"), react_1.default.createElement("input", { onChange: this.handleName.bind(this) }), react_1.default.createElement("div", null, "Type"), react_1.default.createElement("select", { id: "operationType", onChange: this.handleType.bind(this) }, operationTypes), react_1.default.createElement("div", null, "Commander"), react_1.default.createElement("select", { id: "operationOfficer", onChange: this.handleOfficer.bind(this) }, staffOfficers), react_1.default.createElement("div", null, "Target"), react_1.default.createElement("input", { type: "text", onChange: this.handleSearch.bind(this) }), react_1.default.createElement("select", { id: "operationTarget", onChange: this.handleTarget.bind(this) }, officers), react_1.default.createElement("button", { onClick: this.startOperation.bind(this) }, "Start Operation"));
        }
    }]);
...
},{"./comparisons":3,"./lib/react":9}],19:[function(require,module,exports){
'use strict';
...
var World = function () {
    ...
    _createClass(World, [{
        ...
        value: function generate(HQ) {
            var amount = config_1.default.random(10) + 5;
